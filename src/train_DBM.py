...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="mnist",
        help=
        "data source to train DBM, possibilities are 'mnist', 'fashion_mnist' and 'faces' <default: 'mnist'>"
    )
    ...
    trainDBM(args.data, args.learning_rate, args.k1, args.k2, args.epochs,
