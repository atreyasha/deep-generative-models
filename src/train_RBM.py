...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="mnist",
        help=
        "data source to train RBM, possibilities are 'mnist', 'fashion_mnist' and 'faces' <default: 'mnist'>"
    )
    ...
    requiredNamed.add_argument(
        ...
        type=str,
        help=
        "consecutive enumeration of visible and hidden units separated by a comma character, eg. 784,500",
        required=True)
    args = parser.parse_args()
    # train RBM based on parameters
    trainRBM(args.data, args.learning_rate, args.k1, args.k2, args.epochs,
